const CLIMATE_SPEC = {
  ...
  '西安': { climateZone: 'HD', climateZoneCN: '寒冷', kBase: 1.8, kMin: 1.6, isCoastal: false, typhoonRisk: false },
  ...
  '武汉': { climateZone: 'HSCW', climateZoneCN: '夏热冬冷', kBase: 2.2, kMin: 2.0, isCoastal: false, typhoonRisk: false },
  '成都': { climateZone: 'HSCW', climateZoneCN: '夏热冬冷', kBase: 2.2, kMin: 2.0, isCoastal: false, typhoonRisk: false },
  '广州': { climateZone: 'HSWA', climateZoneCN: '夏热冬暖', kBase: 2.4, kMin: 2.2, isCoastal: true, typhoonRisk: true },
  '深圳': { climateZone: 'HSWA', climateZoneCN: '夏热冬暖', kBase: 2.5, kMin: 2.3, isCoastal: true, typhoonRisk: true }
};
