function buildRedlineRegistry({ TERM, getTierLabel, getField }) {
  return [
    ...
    { id: 'R14', text: '须提供安全玻璃 3C 认证标识或型号可查文件', level: 'mandatory', softened: false, trigger: (a, r) => !!(r && r.needsSafetyGlass), group: '安全玻璃', userMeaning: '安全玻璃必须有明确的身份标识，3C认证是最基本的核查方式。安装前须核对玻璃边部标识与合同约定一致。' },
