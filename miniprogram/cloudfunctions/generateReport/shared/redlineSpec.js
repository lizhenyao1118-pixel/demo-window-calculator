function buildRedlineRegistry({ TERM, getTierLabel, getField }) {
  return [
    ...
    // 7. 安全玻璃
    { id: 'R13', text: '落地窗、大面积玻璃、有儿童家庭等场景，夹胶构造为强制要求', level: 'mandatory', softened: false, trigger: (a, r) => !!(r && r.safetyForced), group: '安全玻璃', userMeaning: '本案存在高碰撞风险部位（落地窗/儿童活动区），此类场景应采用夹层安全玻璃，碎片不脱落。商家若以"钢化玻璃同样安全"替代，须提供该部位适用的安全玻璃类型依据，否则不予接受。' },
